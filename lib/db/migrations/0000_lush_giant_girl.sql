...
CREATE TABLE "participations" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "participations_pot_id_user_id_unique" UNIQUE("pot_id","user_id")
);
--> statement-breakpoint
CREATE TABLE "pots" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE INDEX "idx_participations_user" ON "participations" USING btree ("user_id","created_at" DESC NULLS LAST);--> statement-breakpoint
